...
public class Report {
	...
	public Report(InputStream inputStream, String title, Collection<?> beanCollection, ExportType exportType,
			HttpServletResponse response) {
	...
	private String getHeaderValue(ExportType exportType) throws UnsupportedEncodingException {
		...
		var fileName = URLEncoder.encode(title.replaceAll("[^\\w-]+", "_") + "_" + dateTimeNow, "UTF-8");
