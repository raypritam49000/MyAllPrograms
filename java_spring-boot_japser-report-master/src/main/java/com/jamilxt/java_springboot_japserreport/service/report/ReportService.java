...
public class ReportService {
	...
	public void downloadTransactionReport(ExportType exportType, HttpServletResponse response)
	...
	private void exportReport(Collection<?> beanCollection, ExportType exportType, HttpServletResponse response)
			throws JRException, IOException {

		InputStream transactionReportStream = getClass()
				.getResourceAsStream("/transaction_report_" + exportType.toString().toLowerCase() + ".jrxml");
